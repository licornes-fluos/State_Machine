...
state_machine1 = StateMachine([state1, state2, state3, state4], [transition1, transition2, transition3, transition4])
state_machine2 = StateMachine([state1, state2, state3, state4], [transition1, transition2, transition3, transition4])
state_machine3 = StateMachine([state1, state2, state3, state4], [transition1, transition2, transition3, transition4])
state_machine4 = StateMachine([state1, state2, state3, state4], [transition1, transition2, transition3, transition4])
